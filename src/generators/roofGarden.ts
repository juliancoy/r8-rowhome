...
export function addRoofGarden(
  ...
  const notes = [
    "Conceptual raised roof garden placed on the left-side roof strip next to the photovoltaic array.",
  ...
  const planterSpecs = [
    { id: "front", x: 2.75, y: 8.8, crop: "herb and pollinator planting" },
    { id: "middle", x: 2.75, y: 15.0, crop: "leafy vegetable planting" },
    { id: "rear", x: 2.75, y: 34.5, crop: "native sedum and pollinator planting" }
  ] as const;
  ...
  box(
    ...
    35.5,
    0.12,
    { x: 2.75, y: 22.0, z: buildingHeight + 0.62 }
  );
  ...
  box(
    ...
    35.5,
    0.18,
    { x: 4.45, y: 22.0, z: buildingHeight + 0.72 }
  );
  ...
  box(
    ...
    30.5,
    0.08,
    { x: 1.45, y: 21.8, z: buildingHeight + 2.1 }
  );
  ...
  box(
    ...
    36.5,
    0.05,
    { x: 2.9, y: 22.0, z: buildingHeight + 0.55 }
  );
}
